...
%%----------------------------------------
\title{Configuration and Study of a Computer Network and Development of a File Transfer Protocol Client}
\author{Alexandre Ferreira\\Paulo Saavedra\\Class nº7}

%% Uncomment next line for PRODEI
\degree{Licenciatura em Engenharia Informática e Computação}

%% Uncomment next line for date of submission
\thesisdate{November 9, 2025}

%% Comment next line copyright text if not used
\copyrightnotice{FEUP - Faculty of Engineering, University of Porto, 2025}
...
% ===============================
% Final Report Structure (Lab 2)
% ===============================

\include{body/introduction}
\include{body/part1_download_application}
\include{body/part2_network_configuration}
